...
module Packs
  class << self
    ...
    # source://packs//lib/packs.rb#227
    sig { void }
    def lint_package_todo_yml_files!; end

    # source://packs//lib/packs.rb#232
...
class Packs::CLI < ::Thor
  # source://packs//lib/packs/cli.rb#30
  ...
  # source://packs//lib/packs/cli.rb#12
  sig { params(pack_name: ::String).void }
  def create(pack_name); end

  # source://packs//lib/packs/cli.rb#133
...
module Packs::Private
  class << self
    # source://packs//lib/packs/private.rb#275
    sig { params(pack_name: ::String, dependency_name: ::String).void }
    def add_dependency!(pack_name:, dependency_name:); end
    ...
    # source://packs//lib/packs/private.rb#346
    sig { params(package: ::ParsePackwerk::Package).void }
    def add_readme_todo(package); end

    # source://packs//lib/packs/private.rb#413
    sig { void }
    def bust_cache!; end

    # source://packs//lib/packs/private.rb#18
    sig { params(pack_name: ::String).returns(::String) }
    def clean_pack_name(pack_name); end

    # source://packs//lib/packs/private.rb#53
    sig do
      params(
        pack_name: ::String,
        enforce_privacy: T::Boolean,
    ...
    # source://packs//lib/packs/private.rb#363
    sig do
      params(
        pack_name: ::String,
        enforce_privacy: T::Boolean,
    ...
    # source://packs//lib/packs/private.rb#438
    sig do
      params(
    ...
    #
    # source://packs//lib/packs/private.rb#608
    sig { params(code: T::Boolean).void }
    def exit_with(code); end

    # source://packs//lib/packs/private.rb#483
    sig { params(packs: T::Array[::Packs::Pack]).void }
    def get_info(packs: T.unsafe(nil)); end

    # source://packs//lib/packs/private.rb#421
    sig { returns(T::Hash[::String, ::String]) }
    def get_package_todo_contents; end

    # source://packs//lib/packs/private.rb#316
    sig { params(origin: ::Pathname, destination: ::Pathname).void }
    def idempotent_mv(origin, destination); end

    # source://packs//lib/packs/private.rb#525
    sig { void }
    def lint_package_todo_yml_files!; end

    # source://packs//lib/packs/private.rb#560
    sig { params(packs: T::Array[::Packs::Pack]).void }
    def lint_package_yml_files!(packs); end

    # source://packs//lib/packs/private.rb#403
    sig { void }
    def load_client_configuration; end

    # source://packs//lib/packs/private.rb#228
    sig do
      params(
        paths_relative_to_root: T::Array[::String],
        per_file_processors: T::Array[::Packs::PerFileProcessorInterface]
    ...
    # source://packs//lib/packs/private.rb#79
    sig do
      params(
        pack_name: ::String,
        paths_relative_to_root: T::Array[::String],
    ...
    # source://packs//lib/packs/private.rb#148
    sig do
      params(
        pack_name: ::String,
        parent_name: ::String,
    ...
    # source://packs//lib/packs/private.rb#303
    sig do
      params(
...
module Packs::Private::InteractiveCli
  class << self
    # source://packs//lib/packs/private/interactive_cli.rb#29
...
# source://packs//lib/packs/private.rb#433
