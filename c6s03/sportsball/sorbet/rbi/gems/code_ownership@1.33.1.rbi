...
module CodeOwnership::Private
  class << self
    ...
    # source://code_ownership//lib/code_ownership/private.rb#87
    sig { params(file: ::String).returns(T::Boolean) }
    def file_tracked?(file); end

    # source://code_ownership//lib/code_ownership/private.rb#105
    sig { params(team_name: ::String, location_of_reference: ::String).returns(::CodeTeams::Team) }
    def find_team!(team_name, location_of_reference); end

    # source://code_ownership//lib/code_ownership/private.rb#115
    sig { returns(::CodeOwnership::Private::GlobCache) }
    def glob_cache; end
    ...
    #
    # source://code_ownership//lib/code_ownership/private.rb#81
