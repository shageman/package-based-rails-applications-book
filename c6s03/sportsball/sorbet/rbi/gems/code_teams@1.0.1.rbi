...
class CodeTeams::Team
  ...
  # @return [Boolean]
  #
  # source://sorbet-runtime/0.5.10910/lib/types/private/methods/_methods.rb#255
  ...
  # source://code_teams//lib/code_teams.rb#106
  sig { returns(::String) }
  def name; end

  # source://code_teams//lib/code_teams.rb#89
  sig { returns(T::Hash[T.untyped, T.untyped]) }
  def raw_hash; end

  # source://code_teams//lib/code_teams.rb#111
  sig { returns(::String) }
  def to_tag; end

  class << self
    # source://code_teams//lib/code_teams.rb#81
    sig { params(raw_hash: T::Hash[T.untyped, T.untyped]).returns(::CodeTeams::Team) }
    def from_hash(raw_hash); end

    # source://code_teams//lib/code_teams.rb#71
