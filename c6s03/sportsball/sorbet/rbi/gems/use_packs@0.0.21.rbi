...
class UsePacks::CLI < ::Thor
  ...
  # source://use_packs//lib/use_packs/cli.rb#159
...
module UsePacks::Private
  class << self
    ...
    # source://use_packs//lib/use_packs/private.rb#412
    sig { void }
    def bust_cache!; end
    ...
    # source://use_packs//lib/use_packs/private.rb#437
    sig do
      params(
    ...
    # source://use_packs//lib/use_packs/private.rb#482
    sig { params(packs: T::Array[::Packs::Pack]).void }
    def get_info(packs: T.unsafe(nil)); end

    # source://use_packs//lib/use_packs/private.rb#420
    ...
    # source://use_packs//lib/use_packs/private.rb#524
    sig { void }
    def lint_package_todo_yml_files!; end

    # source://use_packs//lib/use_packs/private.rb#559
    sig { params(packs: T::Array[::Packs::Pack]).void }
    def lint_package_yml_files!(packs); end

    # source://use_packs//lib/use_packs/private.rb#402
    sig { void }
    ...
    #
    # source://use_packs//lib/use_packs/private.rb#612
    sig { params(code: ::Integer).void }
    def safe_exit(code); end

    # source://use_packs//lib/use_packs/private.rb#586
    sig { params(config: T::Hash[T.anything, T.anything]).returns(T::Hash[T.anything, T.anything]) }
    def sort_keys(config); end

    # source://use_packs//lib/use_packs/private.rb#592
    sig { params(packs: T::Array[::Packs::Pack]).void }
    def visualize(packs: T.unsafe(nil)); end

    # source://use_packs//lib/use_packs/private.rb#454
...
module UsePacks::Private::InteractiveCli
  class << self
    # source://use_packs//lib/use_packs/private/interactive_cli.rb#30
...
# source://use_packs//lib/use_packs/private.rb#432
...
class UsePacks::RubocopPostProcessor
  ...
  # source://use_packs//lib/use_packs/rubocop_post_processor.rb#26
  sig { returns(T::Boolean) }
