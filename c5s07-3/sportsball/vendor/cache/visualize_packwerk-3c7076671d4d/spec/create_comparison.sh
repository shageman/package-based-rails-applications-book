...
convert sample_app1/tests/roll_nested_todos_into_top_level.png sample_app1/tests/roll_nested_todos_into_top_level_new.png +append sample_app1/tests/roll_nested_todos_into_top_level_new.png
convert sample_app1/tests/focus_folder.png sample_app1/tests/focus_folder_new.png +append sample_app1/tests/focus_folder_new.png
...
convert sample_app1/tests/plain_appened_new.png \
  ...
  sample_app1/tests/roll_nested_todos_into_top_level_new.png \
  sample_app1/tests/focus_folder_new.png \
