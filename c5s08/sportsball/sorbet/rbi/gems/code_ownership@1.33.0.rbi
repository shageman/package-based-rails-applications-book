...
module CodeOwnership::Private
  class << self
    # source://code_ownership//lib/code_ownership/private.rb#39
    sig { void }
    def bust_caches!; end

    # source://code_ownership//lib/code_ownership/private.rb#25
    sig { returns(::CodeOwnership::Configuration) }
    def configuration; end

    # source://code_ownership//lib/code_ownership/private.rb#85
    sig { params(file: ::String).returns(T::Boolean) }
    def file_tracked?(file); end

    # source://code_ownership//lib/code_ownership/private.rb#103
    sig { params(team_name: ::String, location_of_reference: ::String).returns(::CodeTeams::Team) }
    def find_team!(team_name, location_of_reference); end

    # source://code_ownership//lib/code_ownership/private.rb#113
    sig { returns(::CodeOwnership::Private::GlobCache) }
    def glob_cache; end
    ...
    #
    # source://code_ownership//lib/code_ownership/private.rb#34
    sig { returns(::CodeOwnership::Configuration) }
    ...
    #
    # source://code_ownership//lib/code_ownership/private.rb#66
    ...
    #
    # source://code_ownership//lib/code_ownership/private.rb#79
    sig { returns(T::Array[::String]) }
    def tracked_files; end

    # source://code_ownership//lib/code_ownership/private.rb#46
...
# source://code_ownership//lib/code_ownership/private/permit_pack_owner_top_level_key.rb#9
class CodeOwnership::Private::PackOwnershipValidator
  include ::Packwerk::Validator

  # source://code_ownership//lib/code_ownership/private/permit_pack_owner_top_level_key.rb#14
  sig do
    override
      .params(
  ...
  # source://code_ownership//lib/code_ownership/private/permit_pack_owner_top_level_key.rb#19
