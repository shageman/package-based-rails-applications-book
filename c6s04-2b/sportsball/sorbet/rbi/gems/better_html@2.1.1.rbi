...
class BetterHtml::Tokenizer::Location < ::Parser::Source::Range
  ...
  # source://parser/3.3.7.1/lib/parser/source/range.rb#92
  def start_column; end

  # source://parser/3.3.7.1/lib/parser/source/range.rb#83
  def start_line; end

  # source://parser/3.3.7.1/lib/parser/source/range.rb#106
  def stop_column; end

  # source://parser/3.3.7.1/lib/parser/source/range.rb#99
  def stop_line; end
