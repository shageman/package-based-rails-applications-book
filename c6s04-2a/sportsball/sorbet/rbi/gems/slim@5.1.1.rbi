...
# @api private
#
# source://slim//lib/slim/embedded.rb#215
class Slim::Embedded::JavaScriptEngine < ::Slim::Embedded::TagEngine
  # @api private
  #
  # source://slim//lib/slim/embedded.rb#220
...
class Slim::Embedded::RubyEngine < ::Slim::Embedded::Engine
  # @api private
  #
  # source://slim//lib/slim/embedded.rb#227
  def on_slim_embedded(engine, body, attrs); end
end
...
# @api public
#
# source://slim//lib/slim/railtie.rb#3
...
class Slim::Splat::Builder
  ...
  #
  # source://slim//lib/slim/splat/builder.rb#9
  def initialize(options); end

  # @api private
  #
  # source://slim//lib/slim/splat/builder.rb#31
  def attr(name, value); end

  # @api private
  #
  # source://slim//lib/slim/splat/builder.rb#75
  def build_attrs; end

  # @api private
  #
  # source://slim//lib/slim/splat/builder.rb#46
  def build_tag(&block); end

  # @api private
  #
  # source://slim//lib/slim/splat/builder.rb#14
  def code_attr(name, escape, value); end

  # @api private
  #
  # source://slim//lib/slim/splat/builder.rb#25
  ...
  # @api private
  #
  # source://slim//lib/slim/splat/builder.rb#108
  def escape_html(escape, value); end

  # @api private
  #
  # source://slim//lib/slim/splat/builder.rb#92
