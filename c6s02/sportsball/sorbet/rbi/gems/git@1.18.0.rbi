...
class Git::Base
  ...
  #
  # source://git//lib/git/base.rb#111
  ...
  # @param options [Hash]
  #
  # source://git//lib/git/base.rb#275
  ...
  #  end
  #
  # source://git//lib/git/base.rb#133
  def chdir; end
  ...
  # source://git//lib/git/base.rb#551
  ...
  #  :ff
  #
  # source://git//lib/git/base.rb#304
  ...
  #   :author
  #
  # source://git//lib/git/base.rb#345
  ...
  #
  # source://git//lib/git/base.rb#352
  ...
  # g.config # returns whole config hash
  #
  # source://git//lib/git/base.rb#144
  def config(name = T.unsafe(nil), value = T.unsafe(nil), options = T.unsafe(nil)); end

  # returns the name of the branch the working directory is currently on
  #
  # source://git//lib/git/base.rb#617
  def current_branch; end

  # deletes a tag
  #
  # source://git//lib/git/base.rb#489
  ...
  #  :match
  #
  # source://git//lib/git/base.rb#323
  ...
  #  @git.dir.writeable?
  #
  # source://git//lib/git/base.rb#160
  def dir; end

  # iterates over the files which are unmerged
  #
  # source://git//lib/git/base.rb#407
  def each_conflict(&block); end

  # fetches changes from a remote branch - this does not modify the working directory,
  # it just gets the changes from the remote if there are any
  #
  # source://git//lib/git/base.rb#369
  def fetch(remote = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git//lib/git/base.rb#503
  def gc; end
  ...
  #
  # source://git//lib/git/base.rb#165
  def index; end
  ...
  # @return [Boolean]
  #
  # source://git//lib/git/base.rb#209
  ...
  # @return [Boolean]
  #
  # source://git//lib/git/base.rb#197
  ...
  # @return [Boolean]
  #
  # source://git//lib/git/base.rb#203
  ...
  #
  # source://git//lib/git/base.rb#217
  def lib; end
  ...
  #
  # source://git//lib/git/base.rb#402
  def merge(branch, message = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://danger/9.3.1/lib/danger/scm_source/git_repo.rb#194
  ...
  # @overload push
  #
  # source://git//lib/git/base.rb#395
  def push(*args, **options); end

  # source://git//lib/git/base.rb#555
  def read_tree(treeish, opts = T.unsafe(nil)); end

  # returns an array of Git:Remote objects
  #
  # source://git//lib/git/base.rb#422
  def remotes; end
  ...
  #
  # source://git//lib/git/base.rb#456
  def remove_remote(name); end

  # repacks the repository
  #
  # source://git//lib/git/base.rb#499
  def repack; end

  # returns reference to the git repository directory
  #  @git.dir.path
  #
  # source://git//lib/git/base.rb#171
  def repo; end

  # returns the repository size in bytes
  #
  # source://git//lib/git/base.rb#176
  def repo_size; end

  # resets the working directory to the provided commitish
  #
  # source://git//lib/git/base.rb#287
  ...
  # source://git//lib/git/base.rb#186
  ...
  #
  # source://git//lib/git/base.rb#447
  def set_remote_url(name, url); end

  # source://git//lib/git/base.rb#191
  ...
  #
  # source://git//lib/git/base.rb#528
  def with_index(new_index); end

  # source://git//lib/git/base.rb#536
  def with_temp_index(&blk); end

  # source://git//lib/git/base.rb#588
  ...
  # source://git//lib/git/base.rb#559
  def write_tree; end
  ...
  class << self
    ...
    #
    # source://git//lib/git/base.rb#705
...
class Git::Lib
  ...
  # @param options [Hash]
  #
  # source://git//lib/git/lib.rb#663
  def add(paths = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#758
  def apply(patch_file); end

  # source://git//lib/git/lib.rb#764
  ...
  # source://git//lib/git/lib.rb#837
  def checkout_file(version, file); end

  # source://git//lib/git/lib.rb#1052
  def checkout_index(opts = T.unsafe(nil)); end
  ...
  #
  # source://git//lib/git/lib.rb#237
  def commit_data(sha); end

  # source://git//lib/git/lib.rb#1035
  ...
  # source://git//lib/git/lib.rb#569
  def config_remote(name); end

  # WRITE COMMANDS ##
  #
  # source://git//lib/git/lib.rb#639
  def config_set(name, value, options = T.unsafe(nil)); end

  # :yields: file, your, their
  #
  # source://git//lib/git/lib.rb#876
  def conflicts; end

  # returns the current version of git, as an Array of Fixnums.
  #
  # source://git//lib/git/lib.rb#1102
  ...
  # source://git//lib/git/lib.rb#947
  def fetch(remote, opts); end

  # source://git//lib/git/lib.rb#200
  def full_log_commits(opts = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#356
  ...
  #
  # source://git//lib/git/lib.rb#17
  def git_work_dir; end

  # source://git//lib/git/lib.rb#591
  def global_config_get(name); end

  # source://git//lib/git/lib.rb#607
  def global_config_list; end

  # source://git//lib/git/lib.rb#647
  ...
  #
  # source://git//lib/git/lib.rb#1024
  def read_tree(treeish, opts = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#891
  def remote_add(name, url, opts = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#910
  def remote_remove(name); end

  # source://git//lib/git/lib.rb#902
  def remote_set_url(name, url); end

  # source://git//lib/git/lib.rb#914
  def remotes; end
  ...
  # source://git//lib/git/lib.rb#213
  def revparse(string); end

  # source://git//lib/git/lib.rb#678
  def rm(path = T.unsafe(nil), opts = T.unsafe(nil)); end
  ...
  # source://git//lib/git/lib.rb#1008
  def tag_sha(tag_name); end

  # source://git//lib/git/lib.rb#918
  def tags; end

  # source://git//lib/git/lib.rb#360
  def tree_depth(sha); end

  # source://git//lib/git/lib.rb#868
  def unmerged; end

  # source://git//lib/git/lib.rb#1048
  def update_ref(ref, commit); end

  # source://git//lib/git/lib.rb#426
  def worktree_add(dir, commitish = T.unsafe(nil)); end

  # source://git//lib/git/lib.rb#435
  def worktree_prune; end

  # source://git//lib/git/lib.rb#431
  def worktree_remove(dir); end

  # source://git//lib/git/lib.rb#406
  ...
  # source://git//lib/git/lib.rb#1180
  def command(*cmd, redirect: T.unsafe(nil), chomp: T.unsafe(nil), &block); end

  # source://git//lib/git/lib.rb#1133
  ...
  #
  # source://git//lib/git/lib.rb#1253
  ...
  #
  # source://git//lib/git/lib.rb#1277
...
# source://git//lib/git/lib.rb#368
Git::Lib::BRANCH_LINE_REGEXP = T.let(T.unsafe(nil), Regexp)

# source://git//lib/git/lib.rb#262
