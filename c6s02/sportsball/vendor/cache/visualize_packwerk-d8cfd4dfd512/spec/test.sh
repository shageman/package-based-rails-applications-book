...
bundle exec visualize_packs --remote-base-url=https://github.com/shageman/visualize_packwerk/tree/main/spec/sample_app --focus_on=packs/model > tests/focussed_on_packs_model_new.dot && dot tests/focussed_on_packs_model_new.dot -Tpng -o tests/focussed_on_packs_model_new.png
