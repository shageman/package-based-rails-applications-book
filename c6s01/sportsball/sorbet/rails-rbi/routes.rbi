...
module GeneratedUrlHelpers
  ...
  # Sigs for route /prediction/new(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def new_prediction_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def new_prediction_url(*args, **kwargs); end

  # Sigs for route /prediction(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def prediction_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def prediction_url(*args, **kwargs); end
